...
abstract class AbstractGenerator
{
     ...
     * @return AbstractGenerator
     */
    public function setSaveAndPrint (bool $saveAndPrint) 
    {
     ...
     * @return AbstractGenerator
     */
    public function setBackColor (int $backColor) 
    {
     ...
     * @return AbstractGenerator
     */
    public function setForeColor (int $foreColor) 
    {
     ...
     */
    abstract public function getCodeString () ;
}