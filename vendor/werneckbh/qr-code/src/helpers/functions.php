...
if (!function_exists('isPng'))
{
     ...
     * @return bool
     */
    function isPng (string $filename)
    {
...
if (!function_exists('isSvg'))
{
     ...
     * @return bool
     */
    function isSvg (string $filename) 
    {
...
if (!function_exists('inString'))
{
     ...
     * @return bool
     */
    function inString (string $haystack, string $needle) 
    {
...
if (!function_exists('validateErrorCorrectionLevel'))
{
     ...
     * @return bool
     */
    function validateErrorCorrectionLevel (string $errorCorrectionLevel) 
    {
...
if (!function_exists('startsWith'))
{
     ...
     * @return bool
     */
    function startsWith (string $needle, string $haystack) 
    {
